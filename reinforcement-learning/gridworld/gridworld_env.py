...
class GridWorldEnv(discrete.DiscreteEnv):
    def __init__(self, num_rows=8, num_cols=12, delay=0.05):
        ...
        trap_cells = [((gold_cell[0] + 1), gold_cell[1]),
                      ...
                      ((gold_cell[0] - 1), gold_cell[1] - 3),
                      ((gold_cell[0] - 3), gold_cell[1] - 3),
                      ((gold_cell[0] - 2), gold_cell[1] - 5),
                      ((gold_cell[0] + 2), gold_cell[1] - 5),
                      ((gold_cell[0] + 2), gold_cell[1] - 3),
                      ((gold_cell[0] + 3), gold_cell[1] + 1),
                      ((gold_cell[0] - 3), gold_cell[1]),
                      ((gold_cell[0]), gold_cell[1] - 6)]
